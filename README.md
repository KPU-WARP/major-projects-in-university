...
>### Contributor
>  - [고선민](https://github.com/orgs/KPU-WARP/people/go4521304)
...
>> __윈도우 프로그래밍__ 
>>* 제한 : 1차 과제, 2차 과제 (코드, 영상, exe, 문서 전부 제한) 
>>* 사유 : 과제 주제 스포 방지, 코드 복붙 방지
  
>> __자료구조__
>>* 제한 : 오목, 롤딕셔너리 (코드, 문서 제한) 
>>* 사유 : 코드 복붙 방지
...
>> __STL__ 
>>* 제한 : 중간과제, 최종과제 (코드, 문서 제한)   
>>* 사유 : 컨테이너 선정, 로직 구현이 점수에 큰 영향을 미침, 코드 복붙 방지
  
>> __게임 소프트웨어 공학__ 
>>* 제한 : 최종 과제 (코드, 커밋 로그 제한)
>>* 사유 : 동일한 주제이며,  코드 복붙 방지
